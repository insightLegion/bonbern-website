...
export function MarqueeAlongSvgPathDemo() {
  return (
    <div className="w-full h-screen relative bg-zinc-50 flex flex-col justify-center items-center overflow-hidden">
      <h2 className="mt-12 text-3xl font-bold text-black">About Us Marquee Demo</h2>
      <div className="relative w-full h-[500px] mt-8">
        ...
        >
          {marqueeImgs.map((img, i) => (
            <div key={i} className="w-14 h-14 rounded-md shadow-md overflow-hidden cursor-pointer">
              <img
                src={img}
                alt={`Example ${i}`}
...
export function Quote() {
  return (
    <div className="mx-auto mb-10 max-w-7xl px-6 md:mb-20 xl:px-0">
      <div className="relative flex flex-col items-center border border-red-500 bg-white p-8 rounded-lg overflow-hidden">
        <DotPattern width={16} height={16} cx={1} cy={1} cr={1} className="fill-slate-500/50" />
        ...
        <div className="relative z-20 mx-auto max-w-7xl rounded-[40px] py-6 md:p-10 xl:py-20 text-black">
