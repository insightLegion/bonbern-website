...
export function CinematicHero({ 
  brandName = "BonBern",
  tagline1 = "Shape perception",
  tagline2 = "without the noise.",
  cardHeading = "Strategic clarity, redefined.",
  cardDescription = <><span className="text-white font-semibold">BonBern</span> empowers brands and public figures with structured accountability, precise behavioral tracking, and beautiful visual timelines.</>,
  metricValue = 365,
  metricLabel = "Days Active",
  ctaHeading = "Start a conversation.",
  ctaDescription = "Join leading visionaries and take control of your narrative today.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-full h-[100dvh] overflow-hidden flex items-center justify-center bg-background text-foreground font-sans antialiased", className)}
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Updates</span>
                        </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Milestone Reached</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">New campaign launched</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Partner Update</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Synced successfully</p>
                  </div>
                </div>
